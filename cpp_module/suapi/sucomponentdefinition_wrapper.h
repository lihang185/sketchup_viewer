#ifndef SBK_SUCOMPONENTDEFINITIONWRAPPER_H
#define SBK_SUCOMPONENTDEFINITIONWRAPPER_H

#include <model.h>

class SUComponentDefinitionWrapper : public SUComponentDefinition
{
public:
    SUComponentDefinitionWrapper();
    ~SUComponentDefinitionWrapper();
...
#endif // SBK_SUCOMPONENTDEFINITIONWRAPPER_H
