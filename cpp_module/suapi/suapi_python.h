...
enum : int {
    ...
    SBK_CVECTOR2D_IDX                                        = 2,
    SBK_CVECTOR3D_IDX                                        = 3,
    SBK_SUATTRIBUTEDICTIONARY_IDX                            = 4,
    SBK_SUCOMPONENTDEFINITION_IDX                            = 5,
    SBK_SUCOMPONENTINSTANCE_IDX                              = 6,
    SBK_SUDRAWINGELEMENT_IDX                                 = 7,
    SBK_SUEDGE_IDX                                           = 8,
    SBK_SUEDGEUSE_IDX                                        = 9,
    SBK_SUENTITIES_IDX                                       = 10,
    SBK_SUENTITY_IDX                                         = 11,
    SBK_SUENTITYITERATOR_IDX                                 = 12,
    SBK_SUFACE_IDX                                           = 13,
    SBK_SULOOP_IDX                                           = 14,
    SBK_SUMATERIAL_IDX                                       = 15,
    SBK_SUMODEL_IDX                                          = 16,
    SBK_SUTEXTURE_IDX                                        = 17,
    SBK_SUVERTEX_IDX                                         = 18,
    SBK_TRIANGLEMESH_IDX                                     = 19,
    SBK_suapi_IDX_COUNT                                      = 20
};
...
enum : int {
    ...
    SBK_SUAPI_STD_VECTOR_STD_WSTRING_IDX                     = 1, // std::vector<std::wstring >
    SBK_SUAPI_STD_VECTOR_SUATTRIBUTEDICTIONARYPTR_IDX        = 2, // std::vector<SUAttributeDictionary* >
    SBK_SUAPI_STD_VECTOR_SUEDGEPTR_IDX                       = 3, // std::vector<SUEdge* >
    SBK_SUAPI_STD_VECTOR_SUFACEPTR_IDX                       = 4, // std::vector<SUFace* >
    SBK_SUAPI_STD_VECTOR_SUCOMPONENTINSTANCEPTR_IDX          = 5, // std::vector<SUComponentInstance* >
    SBK_SUAPI_STD_VECTOR_SULOOPPTR_IDX                       = 6, // std::vector<SULoop* >
    SBK_SUAPI_STD_VECTOR_SUEDGEUSEPTR_IDX                    = 7, // std::vector<SUEdgeUse* >
    SBK_SUAPI_STD_VECTOR_SUVERTEXPTR_IDX                     = 8, // std::vector<SUVertex* >
    SBK_SUAPI_STD_VECTOR_SUCOMPONENTDEFINITIONPTR_IDX        = 9, // std::vector<SUComponentDefinition* >
    SBK_SUAPI_STD_VECTOR_SUMATERIALPTR_IDX                   = 10, // std::vector<SUMaterial* >
    SBK_suapi_CONVERTERS_IDX_COUNT                           = 11
};
